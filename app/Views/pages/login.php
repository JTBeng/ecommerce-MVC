<div class="relative flex h-auto max-w-8xl flex-col items-center justify-center   group/design-root overflow-x-hidden p-2">
    <div class="flex w-full max-w-md flex-col items-center gap-6 rounded-xl bg-background-light p-6 shadow-sm sm:p-8">
        <div class="flex flex-col items-center gap-2 text-center">
            ...
            <h1 class="tracking-tight text-xl font-bold leading-tight">Bienvenido de vuelta</h1>
            <p class="text-gray-600   font-normal leading-normal">Inicia sesión para continuar en tu cuenta.</p>
        </div>
        <form class="flex w-full flex-col gap-4">
            <div class="flex flex-col w-full">
                <label class="flex flex-col min-w-40 flex-1">
                    <p class=" font-medium leading-normal pb-2">Correo Electrónico</p>
                    <input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg  focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#dbe2e6]  bg-white focus:border-primary  h-4 placeholder:text-[#617c89] p-[15px]  font-normal leading-normal" placeholder="tu@correo.com" type="email" value="" />
                </label>
            </div>
            <div class="flex flex-col w-full">
                <label class="flex flex-col min-w-40 flex-1">
                    <p class=" font-medium leading-normal pb-2">Contraseña</p>
                    <div class="flex w-full flex-1 items-stretch rounded-lg">
                        <input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-l-lg  focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#dbe2e6]  bg-white focus:border-primary  h-14 placeholder:text-[#617c89] p-[15px] border-r-0 pr-2  font-normal leading-normal" placeholder="Ingresa tu contraseña" type="password" value="" />
                ...
                <a class="text-primary hover:underline  font-medium text-right mt-2" href="#">¿Olvidaste tu contraseña?</a>
            </div>
            <button class="flex items-center justify-center w-full h-8 px-6 py-3 mt-4  font-bold text-white rounded-full bg<?= $config['color_principal'] ?> hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2  transition-colors duration-300" type="submit">Iniciar Sesión</button>
            <div class="relative flex items-center py-2">
                <div class="flex-grow border-t border-gray-300 "></div>
                <span class="flex-shrink mx-4  text-gray-500 ">O inicia sesión con</span>
                <div class="flex-grow border-t border-gray-300 "></div>
            </div>
