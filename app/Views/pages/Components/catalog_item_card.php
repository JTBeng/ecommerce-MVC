<section>
    <?php if (!empty($wishList) || !empty($cartList)):
        if (!empty($wishList)):
            $products = $wishList;
    ...
    ?>
        ...
        <div class="grid grid-cols-1 <?= !empty($cartList) ? '' : 'sm:grid-cols-2 lg:grid-cols-3' ?> gap-4">
    ...
    <?php else: ?>
        <p class="px-4">No hay productos en la lista de deseos.</p>
    <?php endif; ?>
</section>