...
<body x-data="{ desktopMenuOpen: false, mobileMenuOpen: false}">
    <main class="h-screen flex flex-col justify-between">
            ...
            <header
                ...
                <a href="/contacto">
                    ...
                    <div class="flex items-center gap-3">
                        <img src="<?= $config['logo_empresa'] ?>" alt="Logo empresa" class="cursor-pointer sm:h-auto sm:w-auto">
                    </div>
                </a>
                ...
                <form class="hidden h-9 w-2/5 items-center border md:flex">
                    ...
                    <button
                        class="ml-auto h-full bg<?= $config['base_clara'] ?> px-4 hover:bg<?= $config['hover'] ?> transition">
                        Buscar
                    </button>
                </form>
            ...
            <div class="mx-auto">
                ...
                <form class="my-4 mx-5 flex h-9 items-center border">
                    ...
                    <ul class=" text-center font-medium">
                        ...
                        <li class="py-2"><a href="/product/index" class="hover:bg<?= $config['hover'] ?>">Productos</a></li>
        ...
        <nav class="relative bg<?= $config['color_principal'] ?>">
            <div
                class="mx-auto hidden h-12 w-full max-w-[1200px] items-center md:flex">
                <button
                    @click="desktopMenuOpen = ! desktopMenuOpen"
                    class="ml-5 flex h-full w-40 cursor-pointer items-center justify-center bg<?= $config['base_clara'] ?>">
                ...
                <div class="mx-7 flex gap-8">
                    <a
                        class="font-light text-white duration-100 hover:text<?= $config['hover'] ?> "
                        href="/">Inicio</a>
                    <a
                        class="font-light text-white duration-100 hover:text<?= $config['hover'] ?> "
                        href="/product/index">Productos</a>
                    <a
                        class="font-light text-white duration-100 hover:text<?= $config['hover'] ?> "
                        href="/sobre_nosotros">Sobre nosotros</a>
                    <a
                        class="font-light text-white duration-100 hover:text<?= $config['hover'] ?> "
        ...
        <section
            ...
            <div class="mx-auto flex max-w-[1200px] py-10">
                <div class="w-[300px] border-r">
                    <ul class="px-5">
                        <li
                            class="active:blue-900 flex items-center gap-2 bg<?= $config['color_secundario'] ?> py-2 px-3 active:bg<?= $config['color_secundario'] ?>">
                            <img
                                width="15px"
                                height="15px"
                        ...
                        <li
                            class="active:blue-900 flex items-center gap-2 py-2 px-3 hover:bg<?= $config['hover'] ?> active:bg<?= $config['color_secundario'] ?>">
                            <img
                                width="15px"
                                height="15px"
